...
# opt into asset
${gcmd} asset send --assetid ${ASSET_ID} -f ${MASTER} -t ${MASTER} -a 0
...
# create transactions
${gcmd} app call --app-id ${APP_ID} --app-arg "str:fund_asa" -f ${MASTER} -o unsignedtx0.tx
${gcmd} asset send --assetid ${ASSET_ID} -f ${ESCROW_ADDRESS} -t ${MASTER} -a 1 -o unsignedtx1.tx
